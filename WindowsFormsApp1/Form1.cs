...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
            ...
            foreach (string i in dsfss)
            {
                ...
                if (info3.Name.IndexOf("1") != -1)                //Dosyanın adında 1 geçiyor ise.
                {
                    ...
                    foreach (string str4 in Directory.GetFiles(cell1_yeni))
                    {
                        ...
                        else if (((info4.Name.IndexOf("CSFB") != -1) || (info4.Name.IndexOf("vc") != -1)) || (info4.Name.IndexOf("4G3G") != -1) || (info4.Name.IndexOf("vc_4G3G") != -1))
                        {
                        ...
                        else if (((info4.Name.IndexOf("Volte") != -1) || (info3.Name.IndexOf("volte") != -1)) || (info3.Name.IndexOf("VOLTE") != -1))
                        {
            ...
            try
            {
                if (Directory.Exists(gelen_yol + @"\Mobility"))   //Seçilen yolda var ise.
                {
                    ...
                    foreach (string i in dosya_var)
                    {
                        if (counter2 == 1)
                        {
                            String mob_change_name = gelen_yol + @"\Logs" + "\\" + "mobility_1800.trp";
                            File.Copy(i, mob_change_name);
                            counter2++;
                            Elements.Items.Add(i);
                        }
                        ...
                        {
                            String mob_change_name = gelen_yol + @"\Logs" + "\\" + "mobility_1800_" + counter2 + ".trp";
                            File.Copy(i, mob_change_name);
                            counter2++;
                            Elements.Items.Add(i);
                        }
        ...
        private string dosyayolu;   //Eski Dosyanın içinin direk kopyala yapıştır yapmak için gerkeken alan.
        private void backScript_Click(object sender, EventArgs e)
        {
            FolderBrowserDialog dialog = new FolderBrowserDialog();
            dialog.ShowDialog();
            this.dosyayolu = dialog.SelectedPath;
            work_rename(dosyayolu);
        }
